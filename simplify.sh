...
for state in {1..9}; do
    ...
    topo2geo < topojson-simplified/${state}.topojson LGA=topojson-simplified/LGA_${state}.json SL=topojson-simplified/SL_${state}.json
    geo2topo LGA=topojson-simplified/LGA_${state}.json SL=topojson-simplified/SL_${state}.json > topojson-simplified/${state}.topojson
